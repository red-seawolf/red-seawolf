...
**This is the official skill for the scrapling library by the library author** (vendored from
[`D4Vinci/Scrapling` `agent-skill/Scrapling-Skill`](https://github.com/D4Vinci/Scrapling/tree/main/agent-skill/Scrapling-Skill),
v0.4.10, license in `LICENSE.txt`). A source-level architecture analysis of the library lives
alongside this skill in `ANALYSIS.md`.
